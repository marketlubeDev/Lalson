      ...
      <div className="about-detail-container">
        ...
        <div className="about-detail-container-content" id="about-us">
          ...
          <p className="about-detail-container-content-text">
            With more than 4 decades of experience in the field of Audio and
            Video and dealing with more than 15 industry leader brands, We are
            your one-stop destination for comprehensive audio-visual solutions,
            ...
            consultation and acoustic works, Complete system AV system
            designing, Testing and calibration.
          </p>
        </div>
        ...
        <div className="about-detail-container-paragraph">
          <p className="about-detail-container-paragraph-text">
            ...
            Paradigm, Dali, JBL, Optoma, BenQ, Epson, Panasonic, and many
            others, we ensure top-notch products along with our after sales
            services. With our expertise and a wide range of solutions, we are
            committed to enhancing your audio-visual experiences with unmatched
